...
Download the plugin ZIP from the [latest release](../downloads/woocommerce-plugin/blackstone-online-gateway-latest.zip). You can also pick a specific version from the [version history](#version-history) at the bottom of this page.
